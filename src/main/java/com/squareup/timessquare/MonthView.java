...
public class MonthView extends LinearLayout {
  ...
  public static MonthView create(ViewGroup parent, LayoutInflater inflater,
    ...
    for (int offset = 0; offset < 7; offset++) {
      ...
      final TextView textView = (TextView)((FrameLayout) headerRow.getChildAt(offset)).getChildAt(0);
  ...
  public void init(MonthDescriptor month, List<List<MonthCellDescriptor>> cells,
      boolean displayOnly, Typeface titleTypeface, Typeface dateTypeface,Map<String,String> map) {
      ...
      if (i < numRows) {
        ...
        for (int c = 0; c < week.size(); c++) {
          ...
          FrameLayout frameLayout = (FrameLayout)weekRow.getChildAt(c);
          CalendarCellView cellView = (CalendarCellView) frameLayout.getChildAt(0);
          ...
          if (map != null && map.get(cellDate) != null){
            textView.setVisibility(VISIBLE);
            textView.setText(map.get(cellDate));
          }else
  ...
  public void setCellListener(Listener listener){
